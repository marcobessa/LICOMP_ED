...
// imprimir o maior valor da árvore 
// Grupo A
...
int maiorValor(No *subarvore) {
    if (subarvore->ad != NULL) {
        return maiorValor(subarvore->ad);
    } else {
        return subarvore->item;
    }
}
